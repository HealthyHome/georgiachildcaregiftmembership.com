...
<div id="introCopy">
      ...
      <div class="infoSignUp">
        ...
        <div class="floatl half" id="info">
          ...
          <!-- Healthy Home Sanitizer -->
          <p class="bodyCopy" style="margin: 0 0 90px 0;">
          <img class="floatl" style="margin-right: 40px; margin-bottom: 20px;" src="images/icon-sanitizer.png">

          <b><span class="green">Healthy Home Sanitizer</span></b><br><br>
          is the perfect replacement for the harmful alcohol-based products and aerosol disinfectants in your home. Our unique hand sanitizer is made from all-natural, organic and ToxicFree&reg; ingredients and an oxygen-rich solution that effectively eliminates bacteria, viruses, fungi and mold.
          </p>
          <div class="clear"></div>  
